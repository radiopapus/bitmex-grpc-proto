...
type GetUserRequest struct {
	...
	ApiSecret     string                 `protobuf:"bytes,1,opt,name=ApiSecret,proto3" json:"ApiSecret,omitempty"`
...
func (x *GetUserRequest) GetApiSecret() string {
	if x != nil {
		return x.ApiSecret
	}
	return ""
...
func (x *GetUserRequest) GetApiId() string {
	if x != nil {
		return x.ApiId
	}
	return ""
...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\x06bitmex\"D\n" +
	"\x0eGetUserRequest\x12\x1c\n" +
	"\tApiSecret\x18\x01 \x01(\tR\tApiSecret\x12\x14\n" +
	"\x05ApiId\x18\x02 \x01(\tR\x05ApiId\"w\n" +
	"\x0fGetUserResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x1c\n" +
	"\tfirstname\x18\x02 \x01(\tR\tfirstname\x12\x1a\n" +
	"\blastname\x18\x03 \x01(\tR\blastname\x12\x1a\n" +
	"\busername\x18\x04 \x01(\tR\busernameB)Z'github.com/radiopapus/bitmex-grpc-protob\x06proto3"
...
var file_user_proto_goTypes = []any{
	...
	(*GetUserResponse)(nil), // 1: bitmex.GetUserResponse
}
